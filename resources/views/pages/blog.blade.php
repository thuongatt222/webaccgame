        ...
        <div class="c-content-box c-size-md">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="art-list">
                            @foreach ($blogs as $key => $bl)
                                <div class="a-item">
                                    <div class="thumbnail-image img-thumbnail"><a href="{{route('blogcon', $bl->slug)}}"><img
                                                src="{{ asset('uploads/blog/' . $bl->image) }}" alt="png-image"></a></div>
                                    <div class="info">
                                        <div class="article_title ">
                                            <h2><a href="{{route('blogcon', $bl->slug)}}" style="text-transform: initial;">{{ $bl->title }}</a>
                                            </h2>
                                        </div>
                                        <div class="article_cat_date">
                                            <div style="display: inline-block;margin-right: 15px"><i class="fa fa-calendar"
                                                    aria-hidden="true"></i> {{ $bl->created_at }}</div>
                                            <div style="display: inline-block"><i class="fa fa-newspaper-o"
                                                    aria-hidden="true"></i> <a href="/blog/huong-dan"
                                                    title="Hướng Dẫn">Hướng
                                                    Dẫn</a></div>
                                        </div>
                                        <div class="article_description hidden-xs">{!! $bl->description !!}</div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
